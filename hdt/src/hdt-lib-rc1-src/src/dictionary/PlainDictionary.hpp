 ...
 * Last modified: $Date: 2012-09-11 18:15:05 +0100 (mar, 11 sep 2012) $
...
#ifdef GOOGLE_HASH 
typedef sparse_hash_map<const char *, DictionaryEntry *, std::hash<const char *>, str_cmp> DictEntryHash;
#else
